...
fig1 <- 
  ...
  layout(xaxis = list(title = "Date"),
         yaxis = list(title = paste0("Average Daily Change (Last 7 Days)"),
                      # range = c(0, 1),
                      tickformat = "%")) %>% 
...
fig3 <- plot_ly(data = plot_data,
               ...
               # alpha = 0.5,
               hoverinfo = "text") %>% 
  layout(yaxis = list(title = "New Cases (over Last 7 Days)")) %>% 
  config(doubleClickDelay = 500)
...
fig4 <- plot_ly(data = plot_data,
  ...
  layout(xaxis = list(title = "Cases Per Thousand People"),
         yaxis = list(title = "New Cases Per Thousand People (over Last 7 Days)")) %>% 
  config(doubleClickDelay = 500)
...
## Appendix: Calculating New Cases (over Last 7 Days)

Calculate "New Cases (over Last 7 Days)" at time $t$ as

$$
\textrm{new cases}_t = \left(\textrm{cases}_t-\textrm{cases}_{t-7}\right)
$$
