...
fig3 <- plot_ly(data = plot_data,
               ...
               # alpha = 0.5,
               hoverinfo = "text") %>% 
  layout(yaxis = list(title = "New Cases (Last 7 Days)")) %>% 
  config(doubleClickDelay = 500)
...
fig4 <- plot_ly(data = plot_data,
  ...
  layout(xaxis = list(title = "Cases Per Thousand People"),
         yaxis = list(title = "New Cases Per Thousand People (Last 7 Days)")) %>% 
  config(doubleClickDelay = 500)
...
## Appendix: Calculating New Cases (Last 7 Days)

Calculate "New Cases (Last 7 Days)" at time $t$ as
