...
*These plots are interactive*: Double click on a region in the legend to start a comparison or use the use the button at the bottom-right corner of the plot and then single click on others to add or remove them from the comparison.  Note: double-clicking may not work well on all platforms, but you may single click on a region in the legend to remove from the comparison.  
