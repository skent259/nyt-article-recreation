...
fig3 <- plot_ly(data = plot_data,
               ...
               text = ~paste0("</br>", Name,
                             "</br>", Date,
                             "</br>Cases: ", Cases, 
                             "</br>New Cases (over Last ", window, " Days): ", `New Cases`),
               type = "scatter",
               mode = 'lines+markers',
               colors = "Paired",
               # alpha = 0.5,
               hoverinfo = "text") %>% 
  layout(yaxis = list(title = paste0("New Cases (over Last ", window, " Days)"))) %>% 
  config(doubleClickDelay = 500)
...
fig4 <- plot_ly(data = plot_data,
               ...
               text = ~paste0("</br>", Name,
                             ...
                             "</br>New Cases Per Thousand </br>(over Last ", window, " Days): ", `New Cases Per Thousand People`),
               type = "scatter",
               mode = 'lines+markers',
               colors = "Paired",
               # alpha = 0.5,
  ...
  layout(xaxis = list(title = "Cases Per Thousand People"),
         yaxis = list(title = paste0("New Cases Per Thousand People (over Last ", window, " Days)"))) %>% 
  config(doubleClickDelay = 500)
...
<!--                                 partial = FALSE)) %>%  -->
<!--   ungroup() %>%  -->
<!--   mutate(`New Cases Per Thousand People (over Last 7 Days)` = round(roll.cases / population * 1000, 3)) %>%  -->
<!--   rename(Name = county.state, -->
<!--          Date = date, -->
<!--          Cases = cases) %>%  -->
<!--   filter(between(Date, MIN_DATE, MAX_DATE)) -->
...
<!--                x = ~Cases, -->
<!--                y = ~`New Cases Per Thousand People (over Last 7 Days)`, -->
<!--                color = ~Name, -->
<!--                text = ~paste0("</br>", Name, -->
<!--                              "</br>", Date, -->
<!--                              "</br>Cases: ", Cases,  -->
<!--                              "</br>New Cases Per Thousand </br>(over Last 7 Days): ", `New Cases Per Thousand People (over Last 7 Days)`), -->
<!--                type = "scatter", -->
<!--                mode = 'lines+markers', -->
<!--                colors = "Paired", -->
<!--                # alpha = 0.5, -->
...
<!--                                 partial = FALSE)) %>%  -->
<!--   ungroup() %>%  -->
<!--   mutate(`New Cases (over Last 7 Days)` = roll.cases) %>%  -->
<!--   rename(Name = county.state, -->
<!--          Date = date, -->
<!--          Cases = cases) %>%  -->
<!--   filter(between(Date, MIN_DATE, MAX_DATE)) -->
...
<!--                x = ~Date, -->
<!--                y = ~`New Cases (over Last 7 Days)`, -->
<!--                color = ~Name, -->
<!--                text = ~paste0("</br>", Name, -->
<!--                              "</br>", Date, -->
<!--                              "</br>Cases: ", Cases,  -->
<!--                              "</br>New Cases (over Last 7 Days): ", `New Cases (over Last 7 Days)`), -->
<!--                type = "scatter", -->
<!--                mode = 'lines+markers', -->
<!--                colors = "Paired", -->
<!--                # alpha = 0.5, -->
...
## Appendix: Calculating New Cases (over Last `r window` Days)

Calculate "New Cases (over Last `r window` Days)" at time $t$ as
