...
```{r unemployment-time, fig.cap = "\\textit{figure caption}", out.width = "90%"}
knitr::include_graphics(
  here("report/figures/unemployment-time.png")
)
```

```{r unemployment-cases, fig.cap = "\\textit{figure caption}", out.width = "90%"}
knitr::include_graphics(
...
```{r new-cases-cases, fig.cap = "\\textit{figure caption}", out.width = "90%"}
knitr::include_graphics(
