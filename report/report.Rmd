...
```{r unemployment-cases, fig.cap = "\\textit{fDaily growth rate of unemployment claims and confirmed cases versus confirmed cases per capita for the state of Wisconsin.}", out.width = "90%"}
knitr::include_graphics(
